...
export class Migration1766933061716 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "users" DROP COLUMN "game_type"`);
        await queryRunner.query(`ALTER TABLE "users" DROP COLUMN "spin_type"`);
        await queryRunner.query(`ALTER TABLE "users" DROP COLUMN "limits"`);
        await queryRunner.query(`ALTER TABLE "users" DROP COLUMN "poker_rooms"`);
